...
_Hanafuda Koi-Koi Collection_ (<span lang="ja">花札こいこいコレクション</span>) is an iOS and Android game for playing [Koi-Koi](/en/hanafuda/games/koi-koi). It is published in 2021 by CHAOS Inc., a game studio from Japan. The game is free to play, and available in both English and Japanese.
...
# Gameplay and Rules
The game closely follows rules from Nintendo's Japanese Koi-Koi pamphlet. See the [Koi-Koi Rules](#koi-koi-rules) section below for more details.
...
## Score Ranks and Collection System
...
* B rank - 10-59 points
* A rank - 60-119 points
* S rank - 120 points or more.

 In total there are 60 B-rank paintings, 36 A-rank paintings, and 38 S-rank paintings you can unlock.
 
## Koi-Koi rules
The game closely follows rules from Nintendo's Japanese Koi-Koi pamphlet. This means:
* The winner's score is doubled if their yaku are worth 7 or more points, or if their opponent has called "koi-koi" in the same round. (These stack, so if both are true, the score is quadrupled.)
* The yaku Boar-Deer-Butterflies (*Ino-Shika-Chō*), Blue Ribbons, and Poetry Ribbons are each worth 5 points plus 1 for each additional Animal/Ribbon card.
* Blue and Poetry Ribbons combine into a separate yaku, worth 10 points plus 1 for each additional Ribbon card.
...
Additionally, in this game only Bright yaku are exclusive with eachother. This means that Blue Ribbons and Poetry Ribbons are _not_ exclusive with the regular Ribbons yaku, and likewise, Boar-Deer-Butterflies is _not_ exclusive with the regular Animals yaku (just like in Nintendo's [Clubhouse Games](/en/hanafuda/video-games/nintendo-switch/51-worldwide-games)).
...
| 役 (*yaku*)              | yaku   |<span style="color:gray">*(same)*</span>|
| こいこい (*koi-koi*)      | Koi-Koi    |<span style="color:gray">*(same)*</span>|
| あがり (*agari*)          | Finish                | *shōbu*            |
| あがる (*agaru*)          | Finish                | call *shōbu*       |
| <h3>Card terms</h3>                                                 |||
| カス札 (*kasu fuda*)      | chaffs card<br/>chaff | Chaff              |
| 短冊札 (*tanzaku fuda*)   | poetry slips card<br/>slip | Ribbon        |
| タネ札 (*tane fuda*)      | animals card<br/>animal| Animal            |
| 光札 (*hikari fuda*)      | light                 | Bright             |
| <h3>Yaku names</h3>                                               |||
| カス (*kasu*)             | Chaffs                | Chaff              |
| タン (*tan*)              | Slips                 | Ribbons            |
| タネ (*tane*)             | Animals  | <span style="color:gray">*(same)*</span>|
| 青短 (*aotan*)            | Blue Slips            | Blue Ribbons       |
| 赤短 (*akatan*)           | Red Slips             | Poetry Ribbons     |
| 赤短・青短 (*akatan-aotan*)| Red&Blue Slips        | Poetry+Blue Ribbons|
| 猪鹿蝶 (*ino-shika-chō*)  | Boar-Deer-Butterfly | <span style="color:gray">*(same)*</span>|
| 月見で一杯<br/>(*tsukimi de ippai*)| Moon Viewing    | Moon Viewing Sake  |
| 花見で一杯<br/>(*hanami de ippai*) | Blossom Viewing | Flower Viewing Sake|
...
# External links
* [iOS App Store](https://apps.apple.com/us/app/hanafuda-koi-koi-collection/id1563705256)
* [Google Play store](https://play.google.com/store/apps/details?id=blue.chaos.koi)