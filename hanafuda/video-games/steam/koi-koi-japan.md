...
* Five Brights (*Gokou*) is worth 200 points instead of 100
* Drinking (*Nomi*) is worth 30 instead of 40
* The three Four-of-a-Kind yaku are worth 20 instead of 10
* Spring *(OmoteSugawara*) can be combined with Bright yaku

# DLC
The following DLCs (downloadable content) are available for Koi-Koi Japan.

* **Koi-Koi Enjoy Pack** - a free add-on with extra cosmetic options
* **UKIYOE tours Vol.1 ~ Vol.3** - a series of three DLCs that each add an extra single-player campaign and an extra character
* **Hana-Awase Rule Add-On** - adds a Hana-Awase gamemode
