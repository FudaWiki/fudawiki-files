...
> For the act of **fortune-telling** using hanafuda cards, see [**Hanafuda Divination**](/en/hanafuda/divination).
{.is-info}
...
1. **Hana-Awase** games are fishing games that have the gameplay element of having to draw a card from the draw pile and playing it to capture a card of the same suit (flower) on the field, hence the name. This includes three subcategories: **Hana-Awase** which are games that have elements specifically designed for playing with Hanafuda, **Mekuri-kei** which are games that have elements that only make sense when played using [Mekurifuda](/en/mekurifuda), and **Tensho-kei** which are games derived from [Tensho](/en/mekurifuda/games/tensho), a predecessor to Mekuri with similar gameplay.
...
|[Roppyakken](/en/hanafuda/games/roppyakken), a.k.a. Roppyakuken or Roppyakuten|2-3|Fishing|Hana-Awase|Japan|
