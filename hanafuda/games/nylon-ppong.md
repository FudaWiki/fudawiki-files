...
The starting player of the first round is randomly decided. From the second round, **the loser of each round becomes the starting player of the next round.**

## Turn

1. At the start of a turn, draw a card from the draw deck.
...
When a card is discarded, a player with two cards of the same month can call 'ppong' [뽕] or 'pong' [뻥], discard those cards and take their turn immediately. Called player does not draw a card at the start of this turn, but must still discard a card to end the turn.
If a player goes out by calling ppong, the round ends immediately.

## Stop

Any player with only 2 cards (after a ppong) can stop the round before drawing a card if their sum of months in hand is below the predetermined limit (usually 5 or 10).
Some players allow stopping the round only when there is at least 1 other player called ppong.

## Scoring

All players get penalty points equal to their hand sum.
For example, [![Pine With Crane](/sheldonchen-cards/10.svg#hanafuda-card =50x)](/en/hanafuda/suits/pine#crane-with-sun)[![Pine With Poetry Ribbon](/sheldonchen-cards/11.svg#hanafuda-card =50x)](/en/hanafuda/suits/pine#poetry-ribbon)[![Plum Blossom with Bush Warbler](/sheldonchen-cards/20.svg#hanafuda-card =50x)](/en/hanafuda/suits/plum-blossom#bush-warbler)[![Cherry Blossom with Curtain](/sheldonchen-cards/30.svg#hanafuda-card =50x)](/en/hanafuda/suits/cherry-blossom#flower-viewing-curtain)[![Susuki Grass Chaff 2](/sheldonchen-cards/83.svg#hanafuda-card =50x)](/en/hanafuda/suits/susuki-grass#chaff)[![Maple with Blue Ribbon](/sheldonchen-cards/101.svg#hanafuda-card =50x)](/en/hanafuda/suits/maple#blue-ribbon) is treated as 1+1+2+3+8+10 = 24 penalty points.
