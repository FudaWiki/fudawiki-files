...
1. At the start of a player's turn, they **draw a card** from the draw deck.
2. If 6 cards in their hand compose a valid [**combination**](/en/hanafuda/games/nylon-ppong#combinations), the player can **end the round** immediately and jump to the scoring.
3. If **not**, they **discard** a card from their hand into the discard pile and end their turn.
