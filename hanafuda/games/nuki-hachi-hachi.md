...
* If 2 ![Icon for month 12](/hanafuda/icons/monthicon_12.png =20x) Paulownia cards are dealt to the table, then **both cards are automatically captured by the dealer**.
...
|2|**Triplet/Three of a Kind**<br/>三本 [さんぼん, *sanbon*]|Any three cards of the same month. If there are two triplets, you can only claim for one.|
|4|**Three Pairs**<br/>喰付 [くっつき, *kuttsuki*] (lit. *sticky?*)|Three pairs of cards- a pair being two cards from the same month.|
|4|**Four of a Kind**<br/>手四 [てし, *teshi*]|Four cards from the same month.|
|8|**Triplet and Two Pairs**<br/>跳剣 [はねけん, *haneken*] (lit. *jumping sword?*)|A Triplet (or Standing Triplet) and two pairs.|
...
* If no *dekiyaku* have been made, then the player who has captured 16 Chaff cards or more is the winner. 
* If neither player captured 16 Chaff cards, then card points are totalled and used to determine the winner. 
...
# Dekiyaku
The dekiyaku in this game are the same as in Hachi-hachi, except the composition of **Seven Ribbons** can include the ![monthicon_11.png](/hanafuda/icons/monthicon_11.png =20x) Willow Ribbon.
...
|10|**Seven Ribbons**<br/>七短 [ななたん, *nanatan*]|Any 7 Ribbon cards, which may or may not include the [![monthicon_11.png](/hanafuda/icons/monthicon_11.png =20x)Willow Ribbon](/en/hanafuda/suits/willow#plain-ribbon).|
