...
The game is notable among Kingo-type games for adding a variation in gameplay, where players may choose to request for cards face-down instead of being visible to the player, which

# The Cards
**48** cards of a standard Hanafuda deck is used. Remove all **November** ![Icon for month 11](/hanafuda/icons/monthicon_11.png =20x) and **December** ![Icon for month 12](/hanafuda/icons/monthicon_12.png =20x) cards.
...
> If all 3 cards are October ![Icon for month 10](/hanafuda/icons/monthicon_10.png =20x), you may request for a re-deal.
{.is-info}
...
### 1. Kingo (Dealer and Bettor - 3x)
**Kingo** (きんご) is a 3-card hand consisting of 3 May ![Icon for month 5](/hanafuda/icons/monthicon_5.png =20x) cards.
...
### 4. Ittan-juuroku (Dealer and Bettor - 3x)
...
### 5. Shippin (Dealer only)
**Shippin** (四一 - しっぴん) is a 2-card hand consisting of an April ![Icon for month 4](/hanafuda/icons/monthicon_4.png =20x) and a January ![Icon for month 1](/hanafuda/icons/monthicon_1.png =20x).

### 6. Kuppin (Dealer only)
**Kuppin** (九一 - くっぴん) is a 2-card hand consisting of a September ![Icon for month 9](/hanafuda/icons/monthicon_9.png =20x) and a January ![Icon for month 1](/hanafuda/icons/monthicon_1.png =20x).

### 7. Shigoro (Dealer and Bettor - 2x)
**Shigoro** (シゴロ) is a 3-card hand consisting of an April ![Icon for month 4](/hanafuda/icons/monthicon_4.png =20x) card, a May ![Icon for month 5](/hanafuda/icons/monthicon_5.png =20x) card, and a June ![Icon for month 6](/hanafuda/icons/monthicon_6.png =20x) card, and is worth 15 points.

If a bettor forms Shigoro, **the payment they receive from the dealer is doubled**.

### 8. Normal 15-point hand
Any hand with a total value of 15 points, which doesn't form any Teyaku.

### 9. Goppin (Dealer only)
**Goppin** (五一 - ごっぴん) is a 2-card hand consisting of a May ![Icon for month 5](/hanafuda/icons/monthicon_5.png =20x) and a January ![Icon for month 1](/hanafuda/icons/monthicon_1.png =20x).

This hand is weaker than any normal 15-point hand.

### 10. Normal hand less than 15 points
