...
This game is originally played using a [mekurifuda](/en/mekurifuda) deck called Ise. It can also be played using Hanafuda; click [here](/en/hanafuda/games/hiyoko) to see the rules using Hanafuda.
